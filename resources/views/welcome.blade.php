...
@section('content')   
    ...
    <section class="hero">
        ...
        @foreach ($photos as $photo)            
            ...
            <div class="hero__item set-bg" data-setbg="img/hero/{{ $photo->photo }}">
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                ...
                                <a href="{{ $photo->btn_link }}" class="primary-btn">{{ $photo->btn }}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="class__form">
                        ...
                        @if ($errors->any())
                            <div style="position: fixed; z-index:11111; top:10%; left: 50%; transform:translate(-50%); background-color:#ff7777; width:50%; padding: 30px; box-shadow: 5px 5px 33px; font-size: 20px;" id="alert01">
                            ...
                            <script>
                                setTimeout(function(){ 
                                    document.getElementById("alert01").classList.add("smoothHide");
                                }, 9000);
                            </script>
                        @endif

                        @if ($message = Session::get('success'))
                            <div style="position: fixed; z-index:11111; top:10%; left: 50%; transform:translate(-50%); background-color:#59b959; width:50%; padding: 30px; box-shadow: 5px 5px 33px; font-size: 20px;" id="alert02">
                                <p>{{ $message }}</p>
                            </div>
                            <script>
                                setTimeout(function(){ 
                        ...
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <select name="type">
                                <option value="Studying">Studying Class</option>
                                <option value="Writting">Writting Class</option>
                                <option value="Reading">Reading Class</option>
                            </select>
                            <input type="text" placeholder="Type your requirements" name="message">
                            <button type="submit" class="site-btn">Send Mesaage</button>
                        </form>
